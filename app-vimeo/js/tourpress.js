...
function sendAccomp(n) {
    ...
    try {
        ...
        if (buildingCode == "bxp_600maryland") {
            buildingCode = "600md"
        }
        else if (buildingCode == "bxp_901ny") {
            buildingCode = "901ny"
        }
        else if (buildingCode == "bxp_5971kingstowne") {
            buildingCode = "5971kingstowne"
        }
        else if (buildingCode == "bxp_5404wisconsin") {
            buildingCode = "wisconsin"
        }
        else if (buildingCode == "bxp_500ncapitol") {
            buildingCode = "500capitol"
        }
        else if (buildingCode == "bxp_2200penn") {
            buildingCode = "2200penn"
        }
        else if (buildingCode == "bxp_2100penn") {
            buildingCode = "2100penn"
        }
        else if (buildingCode == "bxp_1750presidents") {
            buildingCode = "1750presidents"
        }
        else if (buildingCode == "bxp_1615") {
            buildingCode = "sumnersq"
        }
        else if (buildingCode == "bxp_1330conn") {
            buildingCode = "1330ct"
        }
        else if (buildingCode == "bxp_11950democracy") {
            buildingCode = "som"
        }
        else if (buildingCode == "bxp_11921freedom") {
            buildingCode = "11911"
        }
        else if (buildingCode == "bxp_11911freedom") {
            buildingCode = "11911"
        }
        else if (buildingCode == "bxp_twodiscoverysquare") {
            buildingCode = "twodiscovery"
        }
        else if (buildingCode == "bxp_401_9th") {
            buildingCode = "marketstn"
        }

...
function krpanoplugin() {
    ...
    function speak_azure(txt, cc, adv, auto) {
        ...
        if (txt) {
            ...
            sp_player = new SpeechSDK.SpeakerAudioDestination();
            synthesizer = new SpeechSDK.SpeechSynthesizer(speechConfig, SpeechSDK.AudioConfig.fromSpeakerOutput(sp_player));
            ...
            if (!adv) {
                try {
                    ...
                    sp_player.onAudioEnd = function (s) {

...
function krpanoplugin() {
    ...
    function show_vid_lib() {
        ...
        container.innerHTML = `<div id="overlay-content">
            ...
            <div class="flex-item" style="text-align:center">
                <img id="close_but" style="cursor:pointer;padding-top:1em" src="../app-vimeo/skin/ak/close_but.png" width="60" height="60" />
            </div>
        </div></div>
            </div>`;
    ...
    //         id: videos[0], // Assuming videos[0] contains the Vimeo video ID
    //         width: 640,
    //         autoplay: true
    //     });
    ...
    //     // Adjust this part if you have a different structure for your videos array
    // }
    ...
    function show_item_lib(scene, floor_id) {
        ...
        let item_lib_content = `<h3>Floor Feature Menu</h3>
            ...
            <div id="item-closest">
            <a style='cursor:pointer;' data-item='fire_ext' class='item-closest-link'><img src='../app-vimeo/skin/ak/hotspots/fire_ext.png' width='45' height='45' /></a>
            <a style='cursor:pointer;' data-item='aed' class='item-closest-link'><img src='../app-vimeo/skin/ak/hotspots/defib.png' width='45' height='45' /></a>
            <a style='cursor:pointer;' data-item='stair' class='item-closest-link'><img src='../app-vimeo/skin/ak/hotspots/stairwell.png' width='45' height='45' /></a>
            </div>
        ...
        container.innerHTML = `<div id="overlay-content">
            ...
            + item_lib_content +
            `<div class="flex-item" style="text-align:center">
                            <img src="../app-vimeo/skin/ak/close_but.png" id="close_but" />
                        </div>
                    </div>
                </div>
            </div>`;
            ...
            if (x.items.length > 0) {
                for (var i = 0; i < x.items.length; i++) {
                    ...
                    if (x.items[i] == "fire_ext") {
                        document.getElementById("item-fire-ext").innerHTML += "<a data-item='fire_ext' data-label='" + p + "' class='item-lib-link'><img src='../app-vimeo/skin/ak/hotspots/fire_ext.png' width='45' height='45' /></a>";
                    }
                    if (x.items[i] == "first_aid") {
                        document.getElementById("item-first-aid").innerHTML += "<a data-item='first_aid' data-label='" + p + "' class='item-lib-link'><img src='../app-vimeo/skin/ak/hotspots/first_aid.png' width='45' height='45' /></a>";
                    }
                    if (x.items[i] == "defib" || x.items[i] == "aed") {
                        document.getElementById("item-defib").innerHTML += "<a data-item='aed' data-label='" + p + "' class='item-lib-link'><img src='../app-vimeo/skin/ak/hotspots/defib.png'  width='45' height='45'/></a>";
                    }
                    if (x.items[i] == "evac_chair") {
                        document.getElementById("item-evac-chair").innerHTML += "<a style='cursor:pointer;' data-item='evac_chair' data-label='" + p + "' class='item-lib-link'><img src='../app-vimeo/skin/ak/hotspots/evac_chair.png'  width='45' height='45'/></a>";
                    }
                }
            }

            if (x.stairs.length > 0) {
                for (let stair of x.stairs) {
                    stairs_here += (stair.toUpperCase() + ',');
                    document.getElementById("item-stairs").innerHTML += "<a style='padding:.5em;font-size:1.3em' data-label='" + p + "' data-item='stair' class='item-lib-link'>" + stair.toUpperCase(); + " </a>";
                }
            }
            // }
        }
        ...
        for (var c in closest) {
            closest[c].onclick = function () {
                sessionStorage.setItem("search_item", this.dataset.item);
                krpano.call('find_item_closest("' + this.dataset.item + '")');
                hide_overlay();
            }
        }
    }
